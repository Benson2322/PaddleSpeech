    ...
    <div class="speech_recognition_new">
      ...
      <div v-else>
        ...
        <div v-else class="end_to_end_suspended_box">
          ...
          <div class="end_to_end_ing_suspended_time">响应时间：{{
              Number(endToEndAcceptStamp) - Number(endToEndSendStamp)
            }}ms
          </div>
        </div>
      </div>
...
import {getCourseList, getCourseText} from '../../../api/ApiTTSChinese';
